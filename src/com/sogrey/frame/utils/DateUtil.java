...
public class DateUtil {
	 ...
	 * @return
	 */
	public static final BigDecimal hoursBetween(Date startDate, Date endDate,
			int scale) {
	...
	public static String format(String date) {
		...
		String newdate = "";
		Date now = new Date();
		BigDecimal c = DateUtil.hoursBetween(DateUtil.stringToDate(date,
				"yyyy-MM-dd HH:mm:ss"), DateUtil.stringToDate(
