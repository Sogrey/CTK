package com.sogrey.frame.views.pulltorefresh;
...
import com.sogrey.frame.views.pulltorefresh.pullableview.Pullable;

/**
 * 自定义的布局，用来管理三个子控件，其中一个是下拉头，一个是包含内容的pullableView（可以是实现Pullable接口的的任何View），
 * 还有一个上拉头，更多详解见博客http://blog.csdn.net/zhongkejingwang/article/details/38868463<br>
 * for example:<br>
 * 
 * <pre>
 * < ?xml version="1.0" encoding="utf-8"?>
 * < org.sogrey.views.pulltorefresh2.PullToRefreshLayout xmlns:android="http://schemas.android.com/apk/res/android"
 ...
 * 
 *     < org.sogrey.views.pulltorefresh2.pullableview.PullableTextView
 ...
 * 
 * < /org.sogrey.views.pulltorefresh2.PullToRefreshLayout>
 * </pre>
 * 
 * Java code:<br>
 * 
 * <pre>
 * PullToRefreshLayout ptrl = ((PullToRefreshLayout) findViewById(R.id.refresh_view));
 * PullableTextView ptrlTxt = ((PullableTextView) findViewById(R.id.content_view));
 * 
 * ptrlTxt.setPullStatus(PullableStatus.PULL_DOWN);// 设置刷新方式为下拉刷新
